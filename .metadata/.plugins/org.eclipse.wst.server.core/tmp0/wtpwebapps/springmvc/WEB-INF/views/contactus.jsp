...
<h1>Registration form</h1>
	...
	<form action = "processform" method ="post"> <!-- Give action as relative url -->
		...
		<div class="form-group">
			<label for="exampleInputPassword">Password</label> <input
				...
				aria-describedby="namePassword" placeholder="Enter Password"
				name ="password"> 
		</div>
		
		<button type="submit" class="btn btn-sucess">Sign Up</button>
